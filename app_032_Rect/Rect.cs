...
class Rect
{
    ...
    public double Top { get { return _top; } set { _top = _point.Y; } }
    public double Left { get { return _left; } set { _left = _point.X; } }
    public double Right { get { return _right; } set { _right = _point.X + _size.Width; } }
    public double Bottom { get { return _bottom; } set { _bottom = _point.Y + _size.Height; } }
    #endregion
